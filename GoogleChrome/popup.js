$(function() {
	...
	function ApplySettings() {
		...
		if (toBool(search_on_site_default)) $('#toogle-search-on_site').prop('checked', toBool(search_on_site_default));

		if (!toBool(show_exactly_phrase)) $('#exatly_phrase').hide();
		if (!toBool(show_filesearch)) $('#file-search').hide();
